    ...
    <div className="relative flex h-screen w-full flex-col bg-[#111a22] overflow-hidden">
      <div className="flex flex-1 flex-col md:flex-row">
        <div className="hidden md:flex md:w-1/2 relative overflow-hidden bg-[#111a22]">
          <Image
            src="/AGENT.png"
            alt="Professional football agent"
            fill
          ...
          <div className="relative z-20 flex flex-col justify-center items-start p-12 text-white">
            ...
            >
              <h1 className="text-5xl font-bold mb-4 leading-tight">
                Connect with Top
                <br />
                <span className="text-[#1172d4]">Football Talent</span>
              </h1>
              <p className="text-xl text-[#92adc9] mb-8 max-w-md">
                Discover talented players, manage your network, and build successful partnerships in the football world.
              </p>
              <div className="flex flex-col gap-3">
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 rounded-full bg-[#1172d4]" />
                  <span className="text-lg">Access to comprehensive player profiles</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 rounded-full bg-[#1172d4]" />
                  <span className="text-lg">Direct communication with players and clubs</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 rounded-full bg-[#1172d4]" />
                  <span className="text-lg">Manage trials and recruitment opportunities</span>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          >
            ...
            <div className="text-center">
              <p className="text-[#92adc9] text-sm">
                ...
                <Link href="/agent/register" className="text-[#1172d4] hover:underline font-semibold">
                  Sign Up
                </Link>
              </p>
            </div>
